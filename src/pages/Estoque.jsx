...
export default function Estoque() {
  ...
  const [form, setForm] = useState({ nome: '', categoria: 'Material escolar', custo_unitario: '', quantidade: '', unidade: 'un' })
  ...
  async function salvar() {
    ...
    setModal(false)
    setForm({ nome: '', categoria: 'Material escolar', custo_unitario: '', quantidade: '', unidade: 'un' })
    setSaving(false)
    load()
  }
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <button className="btn btn-primary" onClick={() => setModal(true)}>+ Novo item</button>
      </div>
          ...
          <tbody>
            {lista.map(i => (
              <tr key={i.id}>
                ...
                <td>
                  <button className="btn btn-sm" onClick={() => { setModalEntrada(i); setEntQtd('') }}>
                    + Entrada
                  </button>
                </td>
              </tr>
        ...
        <div className="modal">
          ...
          <div className="form-grid">
            <div className="form-row">
              ...
              <input value={form.nome} onChange={e => setForm({ ...form, nome: e.target.value })} placeholder="Ex: Pincel atômico" />
            </div>
            <div className="form-row">
            ...
            <div className="form-row">
              <label>Unidade</label>
              <input value={form.unidade} onChange={e => setForm({ ...form, unidade: e.target.value })} placeholder="un, cx, pct..." />
            </div>
          </div>
